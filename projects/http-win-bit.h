...
#define BLD_CFG_PREFIX "C:/Program Files (x86)/Http Library"
#define BLD_BIN_PREFIX "C:/Program Files (x86)/Http Library/bin"
#define BLD_DOC_PREFIX "C:/Program Files (x86)/Http Library/doc"
#define BLD_INC_PREFIX "C:/Program Files (x86)/Http Library/inc"
#define BLD_JEM_PREFIX "C:/Program Files (x86)/Http Library/jems"
#define BLD_LIB_PREFIX "C:/Program Files (x86)/Http Library/bin"
#define BLD_LOG_PREFIX "C:/Program Files (x86)/Http Library/logs"
#define BLD_MAN_PREFIX "C:/Program Files (x86)/Http Library/man"
#define BLD_PRD_PREFIX "C:/Program Files (x86)/Http Library"
#define BLD_SAM_PREFIX "C:/Program Files (x86)/Http Library/samples"
#define BLD_SPL_PREFIX "C:/Program Files (x86)/Http Library/tmp"
#define BLD_SRC_PREFIX "C:/Program Files (x86)/Http Library/src"
#define BLD_VER_PREFIX "C:/Program Files (x86)/Http Library"
#define BLD_WEB_PREFIX "C:/Program Files (x86)/Http Library/web"
#define BLD_EXE ".exe"
