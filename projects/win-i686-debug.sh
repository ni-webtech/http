...
"link" -dll -out:${PLATFORM}/bin/libhttp.dll -entry:_DllMainCRTStartup@12 -def:${PLATFORM}/bin/libhttp.def ${LDFLAGS} ${PLATFORM}/obj/auth.obj ${PLATFORM}/obj/authCheck.obj ${PLATFORM}/obj/authFile.obj ${PLATFORM}/obj/authPam.obj ${PLATFORM}/obj/cache.obj ${PLATFORM}/obj/chunkFilter.obj ${PLATFORM}/obj/${CC}ient.obj ${PLATFORM}/obj/conn.obj ${PLATFORM}/obj/endpoint.obj ${PLATFORM}/obj/error.obj ${PLATFORM}/obj/host.obj ${PLATFORM}/obj/httpService.obj ${PLATFORM}/obj/log.obj ${PLATFORM}/obj/netConnector.obj ${PLATFORM}/obj/packet.obj ${PLATFORM}/obj/passHandler.obj ${PLATFORM}/obj/pipeline.obj ${PLATFORM}/obj/queue.obj ${PLATFORM}/obj/rangeFilter.obj ${PLATFORM}/obj/route.obj ${PLATFORM}/obj/rx.obj ${PLATFORM}/obj/sendConnector.obj ${PLATFORM}/obj/stage.obj ${PLATFORM}/obj/trace.obj ${PLATFORM}/obj/tx.obj ${PLATFORM}/obj/uploadFilter.obj ${PLATFORM}/obj/uri.obj ${PLATFORM}/obj/var.obj ${PLATFORM}/bin/libws2_32.lib ${PLATFORM}/bin/libadvapi32.lib ${PLATFORM}/bin/libuser32.lib ${PLATFORM}/bin/libkernel32.lib ${PLATFORM}/bin/liboldnames.lib ${PLATFORM}/bin/libmsvcrt.lib ${PLATFORM}/bin/libmpr.lib ${PLATFORM}/bin/libpcre.lib
