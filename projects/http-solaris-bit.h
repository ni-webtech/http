/*
    bit.h -- Build It Configuration Header for solaris-i686
...
#define BLD_CONFIG_CMD "bit -emulate solaris-i686 -without all configure -gen sh,make"
...
#define BLD_CC_UNNAMED_UNIONS 0
