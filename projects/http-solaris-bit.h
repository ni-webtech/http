...
#define BIT_CONFIG_CMD "bit -emulate solaris-x86 -q -d -without all configure -gen sh,make"
...
#define BIT_LIB_PREFIX "/usr/lib/http/1.0.0/bin"
...
#define BIT_CC_UNNAMED_UNIONS 0
